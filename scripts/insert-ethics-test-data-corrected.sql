-- Script corrigido para inserir dados de teste completos no módulo de ética

-- Primeiro, inserir casos de ética de exemplo (usando colunas corretas)
...
(
    ...
    (SELECT id FROM ethics_reports WHERE protocol_number = 'ETH-2025-001' AND tenant_id = '46b1c048-85a1-423b-96fc-776007c8de1f'),
    'created',
    'Caso criado no sistema',
    (SELECT id FROM profiles WHERE tenant_id = '46b1c048-85a1-423b-96fc-776007c8de1f' LIMIT 1),
    'Sistema',
    '2025-01-16 09:00:00',
    '{"source": "web", "ip": "192.168.1.100"}'
),
(
    '46b1c048-85a1-423b-96fc-776007c8de1f',
    (SELECT id FROM ethics_reports WHERE protocol_number = 'ETH-2025-001' AND tenant_id = '46b1c048-85a1-423b-96fc-776007c8de1f'),
    'investigation_started',
    'Investigação iniciada - Plano de investigação criado',
    (SELECT id FROM profiles WHERE tenant_id = '46b1c048-85a1-423b-96fc-776007c8de1f' LIMIT 1),
    'Investigador Principal',
    '2025-01-20 09:30:00',
    '{"investigation_type": "full", "estimated_days": 45}'
),
(
    '46b1c048-85a1-423b-96fc-776007c8de1f',
    (SELECT id FROM ethics_reports WHERE protocol_number = 'ETH-2025-002' AND tenant_id = '46b1c048-85a1-423b-96fc-776007c8de1f'),
    'evidence_collected',
    'Evidência coletada - Depoimentos de testemunhas',
    (SELECT id FROM profiles WHERE tenant_id = '46b1c048-85a1-423b-96fc-776007c8de1f' LIMIT 1),
    'Investigador Externo',
    '2025-01-26 15:00:00',
    '{"evidence_type": "testimony", "witnesses": 2}'
);