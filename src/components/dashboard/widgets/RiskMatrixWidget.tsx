        ...
        <Card className="h-full flex flex-col bg-card border-border shadow-sm">
            ...
            <CardContent className="flex-1 p-6 flex flex-col items-center justify-center">
                {loading ? <Loader2 className="w-8 h-8 animate-spin text-muted-foreground" /> : (
                    <div className="w-full max-w-[700px] aspect-square relative grid grid-cols-[auto_1fr] grid-rows-[1fr_auto] gap-2">
                                            ...
                                            <TooltipProvider key={`${rowIndex}-${colIndex}`}>
                                                <Tooltip delayDuration={0}>
                                                    <TooltipTrigger asChild>
                                                        ...
                                                        >
                                                            {/*
                                                              V20 FIX: NESTED BACKGROUND LAYER
                                                              This bypasses global CSS resets on interactive elements.
                                                              Anexo 2 Style: Solid Color (cell.bg)
                                                            */}
                                                            <div
            ...
            {/* LEGEND SECTION */}
            {!loading && (
                <div className="px-6 pb-6 pt-4 border-t border-border/50 bg-secondary/5 mt-auto">
