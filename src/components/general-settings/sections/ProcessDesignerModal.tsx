          ...
          <div className="flex-1 overflow-auto bg-gray-50 dark:bg-gray-900 relative">
            ...
            {formFields.length === 0 ? (
              <div className="absolute inset-0">
                ...
                <div
                  className={`absolute inset-0 border-2 border-dashed border-gray-300 dark:border-gray-600 bg-gray-100/20 dark:bg-gray-800/20 transition-all duration-300 ${dropTarget ? 'border-green-400 dark:border-green-500 bg-green-50/30 dark:bg-green-900/30' : ''
                    }`}
                  onDragOver={(e) => {
                    e.preventDefault();
                            ...
                            if (fieldInPosition) {
                              return (
                                <div
                                  ...
                                  className={`bg-card dark:bg-card/50 rounded-xl border border-border p-4 shadow-sm hover:shadow-md transition-all duration-200 group relative min-h-[120px] cursor-move ${draggedField?.id === fieldInPosition.id ? 'opacity-50 scale-95' : ''
                                    }`}
                                  draggable
...
export const ProcessDesignerModal: React.FC<ProcessDesignerModalProps> = ({
          ...
          {selectedWorkflowNode?.id === node.id && (
            <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 
              ...
              <Button
                size="sm"
                variant="ghost"
                className={`h-6 w-6 p-0 rounded-md transition-all duration-200 ${isConnecting && connectionSource?.id === node.id
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center">
      <div className={`bg-white dark:bg-gray-900 shadow-2xl transition-all duration-300 ${isMaximized
        ...
        <div className="px-6 py-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-8">
            {/* Step 1 */}
            <div className={`flex items-center space-x-3 px-4 py-2 rounded-lg transition-all duration-300 ${currentStep === 'form-builder'
              ...
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${currentStep === 'form-builder'
            ...
            {/* Step 2 */}
            <div className={`flex items-center space-x-3 px-4 py-2 rounded-lg transition-all duration-300 ${currentStep === 'workflow-designer'
                ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 shadow-md'
                : formFields.length > 0
              ...
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${currentStep === 'workflow-designer'
                  ? 'bg-blue-500 text-white'
