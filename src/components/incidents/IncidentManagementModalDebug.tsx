...
const IncidentManagementModalDebug: React.FC<IncidentManagementModalProps> = ({
  incident,
  isOpen,
  onClose,
  onSuccess
  ...
  const validateForm = (): boolean => {
    ...
    console.log('📋 FormData para validação:', formData);
    ...
    // Validar tenant apenas se não for platform admin
    if (!tenantId && !user?.isPlatformAdmin) {
      console.log('❌ Tenant ID obrigatório mas não encontrado');
      ...
      console.log('✅ Tenant ID válido ou usuário é platform admin');
    }
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-xs text-gray-500 p-3 bg-gray-50 rounded border">
            ...
            <br />
            <strong>Tenant ID:</strong> {tenantId || 'N/A'}
            <br />
...
export default IncidentManagementModalDebug;