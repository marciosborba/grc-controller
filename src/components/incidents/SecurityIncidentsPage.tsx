    ...
    <div className="space-y-6">
      <div className="flex flex-col space-y-4 sm:flex-row sm:justify-between sm:items-center sm:space-y-0">
        <div className="flex-1 min-w-0">
          <h1 className="text-2xl sm:text-3xl font-bold truncate">Incidentes de Segurança</h1>
          <p className="text-muted-foreground text-sm sm:text-base">Gerencie e monitore incidentes de segurança</p>
        </div>
