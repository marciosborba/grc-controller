          ...
          <CardContent className="pt-4">
            <div className="flex items-center">
              ...
              <div className="ml-2">
                ...
                <p className="text-lg font-bold text-red-600">{metrics.criticalRisks}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center">
              ...
              <div className="ml-2">
                <p className="text-xs font-medium text-muted-foreground">Altos</p>
                <p className="text-lg font-bold text-orange-600">{metrics.highRisks}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-4">
            <div className="flex items-center">
              ...
              <div className="ml-2">
                ...
                <p className="text-lg font-bold">{metrics.overdueRisks}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-4">
            <div className="flex items-center">
              ...
              <div className="ml-2">
                ...
                <p className="text-lg font-bold">{metrics.averageRiskScore}</p>
              </div>
            </div>
          </CardContent>
        </Card>
