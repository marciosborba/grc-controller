...
const NewVendorRiskManagement: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Matriz de Risco Preview */}
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg">Matriz de Risco - Preview</CardTitle>
        ...
        <CardContent>
          ...
          <div className="max-w-xs mx-auto">
            ...
            <div className="inline-block mx-auto">
              <div className="flex">
                <div className="flex flex-col justify-center items-center mr-2">
                  <div className="text-xs font-medium text-muted-foreground transform -rotate-90 whitespace-nowrap mb-1">
                    IMPACTO
                  </div>
                </div>
                ...
                <div className="space-y-0">
                  ...
                  <div className="flex">
                    <div className="flex flex-col space-y-0 mr-1">
                      {[5, 4, 3, 2, 1].map((num) => (
                        <div key={num} className="h-6 w-6 flex items-center justify-center text-xs font-medium text-muted-foreground">
                          {num}
                        </div>
                      ))}
                    </div>
                    ...
                    {/* 5x5 Grid */}
                    <div className="grid grid-rows-5 gap-0 border border-gray-300 dark:border-gray-600">
                      {/* Row 5 (top) */}
                      <div className="grid grid-cols-5 gap-0">
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#ef4444'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#ef4444'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#ef4444'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#ef4444'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#ef4444'}}></div>
                      ...
                      {/* Row 4 */}
                      <div className="grid grid-cols-5 gap-0">
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#f97316'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#ef4444'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#ef4444'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#ef4444'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#ef4444'}}></div>
                      ...
                      {/* Row 3 */}
                      <div className="grid grid-cols-5 gap-0">
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#eab308'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#f97316'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center relative" style={{backgroundColor: '#eab308'}}>
                          <div className="absolute inset-0 flex items-center justify-center">
                            <div className="w-1.5 h-1.5 bg-blue-600 border border-white rounded-full shadow-lg"></div>
                          </div>
                        </div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#f97316'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#ef4444'}}></div>
                      ...
                      {/* Row 2 */}
                      <div className="grid grid-cols-5 gap-0">
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#84cc16'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#eab308'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#eab308'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#f97316'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#f97316'}}></div>
                      ...
                      {/* Row 1 (bottom) */}
                      <div className="grid grid-cols-5 gap-0">
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#22c55e'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#84cc16'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#eab308'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#eab308'}}></div>
                        <div className="h-6 w-6 border border-gray-200 dark:border-gray-600 flex items-center justify-center" style={{backgroundColor: '#f97316'}}></div>
                  ...
                  <div className="flex justify-center mt-1">
                    <div className="flex space-x-0 ml-7">
                      {[1, 2, 3, 4, 5].map((num) => (
                        <div key={num} className="h-6 w-6 flex items-center justify-center text-xs font-medium text-muted-foreground">
                          {num}
                        </div>
              ...
              <div className="flex flex-wrap justify-center gap-1 text-xs">
                {[
                  ...
                  <div key={level} className="flex items-center space-x-1">
                    <div className="w-2 h-2 rounded border" style={{ backgroundColor: color }}></div>
            ...
            {/* Risk Position */}
            <div className="text-center mt-3 p-2 bg-muted/50 rounded-lg">
              <p className="text-xs">
                Posição: <strong>Médio</strong> (3.2, 2.8)
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-muted-foreground">
              Distribuição dos riscos de fornecedores por nível de criticidade
            </p>
          </div>
        </CardContent>
      </Card>
