...
import type { Assessment } from '@/types/assessment-management';
...
const SortableAssessmentCard: React.FC<SortableAssessmentCardProps> = (props) => {
  const {
    attributes,
    listeners,
    setNodeRef,
...
export default SortableAssessmentCard;