...
interface SortableEthicsReportCardProps {
  report: EthicsReport;
...
const SortableEthicsReportCard: React.FC<SortableEthicsReportCardProps> = (props) => {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    ...
    >
      ...
      {/* Ethics Report Card */}
      <EthicsReportCard {...props} />
    </div>
  );
};

export default SortableEthicsReportCard;