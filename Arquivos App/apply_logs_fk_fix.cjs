...
const SQL_FILE = 'c:/Users/marci/.gemini/antigravity/brain/8b97270b-b1ad-4e4d-86b2-38535a43fac6/fix_logs_fk.sql';
...
(async () => {
    ...
    try {
        ...
        console.log('🚀 Fixing Logs FK...');

        await client.query(sql);
        console.log('✅ Logs FK fixed successfully!');
