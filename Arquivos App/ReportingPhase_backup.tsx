        ...
        <style>
          ...
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .executive-summary {
            ...
            border-left: 4px solid ${tipo === 'tecnico' ? '#0f172a' : '#1e3a8a'};
            padding: 25px;
            border-radius: 8px;
            margin: 20px 0;
            position: relative;
        ...
        <div class="page">
          ...
          <div class="header-page">
            <div class="header-content">
              <h1 class="main-title">${tipo === 'tecnico' ? 'RELATÓRIO TÉCNICO DE AUDITORIA' : tipoTitulos[tipo]}</h1>
          ...
          <!-- CONTEÚDO PRINCIPAL -->
          <div class="content">
            <!-- ${tipo === 'tecnico' ? 'SUMÁRIO EXECUTIVO TÉCNICO' : 'RESUMO EXECUTIVO'} -->
            <div class="section">
            ...
            <!-- ${tipo === 'tecnico' ? 'PROCEDIMENTOS DE AUDITORIA' : 'INDICADORES PRINCIPAIS'} -->
            <div class="section">
              <h2 class="section-title">
                ${tipo === 'tecnico' ? 'PROCEDIMENTOS DE AUDITORIA EXECUTADOS' : 'INDICADORES PRINCIPAIS'}
              </h2>
