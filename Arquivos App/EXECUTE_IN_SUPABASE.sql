...
DO $$
BEGIN
    RAISE NOTICE '🚀 Iniciando adição de campos do wizard...';
    ...
    RAISE NOTICE '🎉 Campos do wizard adicionados com sucesso!';
END $$;
...
DO $$
BEGIN
    RAISE NOTICE '🔧 Adicionando constraints...';
    ...
    RAISE NOTICE '🎉 Constraints adicionadas com sucesso!';
END $$;
...
SELECT 
    '🔍 VERIFICAÇÃO FINAL - Campos do wizard criados:' as status;
...
SELECT '✅ Script executado com sucesso! Agora todos os campos do wizard serão salvos corretamente.' as resultado;