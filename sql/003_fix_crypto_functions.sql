-- ============================================================================
-- CORREÇÃO DAS FUNÇÕES DE CRIPTOGRAFIA
-- ============================================================================
...
BEGIN
    ...
    v_encrypted_bytea := extensions.pgp_sym_encrypt(p_plaintext::bytea, v_derived_key, 'cipher-algo=' || v_cipher);
...
BEGIN
    ...
    v_decrypted_bytea := extensions.pgp_sym_decrypt(v_encrypted_bytea, v_derived_key);
    
    -- Converter bytea para texto
    v_result := convert_from(v_decrypted_bytea, 'UTF8');
