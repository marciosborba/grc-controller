...
-- Updated to use auth.audit_log_entries for reliable login tracking.
...
BEGIN
  ...
  -- Active Users (24h) - Updated to use auth.audit_log_entries for reliability
  -- Falls back to activity_logs if audit log is empty (for backward compatibility/dev)
  ...
  -- Fallback if 0 found in audit logs (maybe legacy logging)
  ...
  -- Risks (using risk_registrations)
  ...
  -- Critical Risks (using risk_registrations)
  ...
  -- Compliance Score Logic Refined
