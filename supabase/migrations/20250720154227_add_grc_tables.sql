...
-- Insert a default vendor to ensure vendor_id is available for assessments
INSERT INTO public.vendors (name, category, risk_level, status) VALUES ('Fornecedor Padrão', 'Tecnologia', 'medium', 'active');
