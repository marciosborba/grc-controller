-- ============================================================
-- Migration: Fix handle_new_user trigger (v4)
-- Fixes:
--   1. Define is_active como FALSE por padrão (Status Pendente)
--   2. Mantém suporte a custom_role_id e mapeamento de roles
-- ============================================================
...
BEGIN
  ...
  IF v_existing_profile_id IS NOT NULL THEN
    UPDATE public.profiles SET
      ...
      email          = NEW.email
      -- We don't force is_active here on update as it might be an existing user
  ...
  ELSE
    INSERT INTO public.profiles (
      ...
      v_system_role,
      v_custom_role_id,
      false, -- Inativo por padrão (Status: Pendente na UI)
      true   -- Deve configurar senha
    );
  END IF;
