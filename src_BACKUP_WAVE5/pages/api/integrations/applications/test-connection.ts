...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    const { type, credentials }: { type: SupportedApplicationIntegration; credentials: ApplicationCredentials } = req.body;
    ...
    console.error('Application connection test error:', error);
